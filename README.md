...
Download drivers [Nvidia driver](http://www.nvidia.es/Download/index.aspx?lang=en-us) If you want to down load the driver directly in a Linux shell, the script below would be useful.
```
cd ~
